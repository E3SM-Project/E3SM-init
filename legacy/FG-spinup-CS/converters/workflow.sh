...
mapfile=/lcrc/group/e3sm/data/inputdata/ocn/mpas-o/oQU240/ocean.QU.240km.151209.nc 
...
# reset the path for regridded data as needed. here use climo/0.5x0.5_bilin/ocn and ice
 for mon in  `seq -w 1 12`; do
     ...
     dstfile_WE=climo/0.5x0.5_bilin/ocn/${caseid}_SST_${monssn}_${timerange}_climo.WE.nc
     ...
     dstfile_WE=climo/0.5x0.5_bilin/ice/${caseid}_iceArea_${monssn}_${timerange}_climo.WE.nc
     dstfile_EW=climo/0.5x0.5_bilin/ice/${caseid}_iceArea_${monssn}_${timerange}_climo.nc
 ...
 ncrcat ${caseid}_SST_??_*_climo.nc -o ${caseid}_SST_climo_${year1}-${year2}.nc
 ...
 ncrcat ${caseid}_iceArea_??_*_climo.nc -o ${caseid}_iceArea_climo_${year1}-${year2}.nc
